...
JOKEAPI.addEventListener("click", function (){
    ...
    fetch ("https://v2.jokeapi.dev/joke/Programming?blacklistFlags=political")
...
UniAPI.addEventListener ('click', function (){
    document.getElementsByClassName(apiSource)[0].innerHTML = "Universities API";
    ...
    .then((data)=>  {
        ...
        data.map((obj)=> {
            ...
            responseText.append(p); //add something inside
